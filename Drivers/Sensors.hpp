...
/*位置传感器*/
	/*位置传感器定义*/
		...
		extern const uint8_t default_vision_pos_sensor_index;
		extern const uint8_t default_vision_height_sensor_index;		
		extern const uint8_t default_vision_speed_sensor_index;
		extern const uint8_t default_vision_height_sensor_index_slam;	
